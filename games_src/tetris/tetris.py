...
bg = pygame.image.load('./resources/graphics/tetris/bg.jpg').convert()
game_bg = pygame.image.load('./resources/graphics/tetris/bg2.jpg').convert()

main_font = pygame.font.Font('./resources/font/tetris.ttf', 65)
font = pygame.font.Font('./resources/font/tetris.ttf', 45)
