...
class Bird(pygame.sprite.Sprite):
    def __init__(self):
        super().__init__()
        bird0 = pygame.image.load('./resources/graphics/flappybird/bird0.png').convert_alpha()
        bird1 = pygame.image.load('./resources/graphics/flappybird/bird1.png').convert_alpha()
        bird2 = pygame.image.load('./resources/graphics/flappybird/bird2.png').convert_alpha()
...
class Tube(pygame.sprite.Sprite):
    def __init__(self, type, y_pos):
        ...
        self.type = type
        self.image = pygame.image.load('./resources/graphics/flappybird/tube.png').convert_alpha()

        if self.type == 'top':
            self.top = pygame.image.load('./resources/graphics/flappybird/tubebottomtop.png').convert_alpha()
            self.rect = self.image.get_rect(midbottom = (300, y_pos))
        else:
            self.bottom = pygame.image.load('./resources/graphics/flappybird/tubebottomdown.png').convert_alpha()
    ...
    def point(self):
        ...
        if self.rect.right == 50:
            score += 0.5
            pygame.mixer.Sound('./resources/audio/flappybird/point.wav').play()
...
def collision_sprite():
    if pygame.sprite.spritecollide(bird.sprite, tube, False):
        pygame.mixer.Sound('./resources/audio/flappybird/hit.wav').play()
        return False
    else:
        return True
...
icon = pygame.image.load('./resources/graphics/flappybird/bird0.png').convert_alpha()
...
# Background
bg_surf = pygame.image.load('./resources/graphics/flappybird/background.png').convert()
ground_surf = pygame.image.load('./resources/graphics/flappybird/ground.png').convert()
...
# Game over
gameover = pygame.image.load('./resources/graphics/flappybird/gameover.png').convert_alpha()
gameover_rect = gameover.get_rect(center = (144, 50))
playbutton = pygame.image.load('./resources/graphics/flappybird/playbutton.png').convert_alpha()
        ...
        if game_active:
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_SPACE:
                    pygame.mixer.Sound('./resources/audio/flappybird/sfx_wing.wav').play()
        else:
