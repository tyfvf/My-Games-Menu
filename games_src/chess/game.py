...
from games_src.chess.board import Board
from games_src.chess.dragger import Dragger
from games_src.chess.config import Config
    ...
    def show_last_move(self, surface):
        ...
        if self.board.last_move:
            ...
            for pos in [initial, final]:
                color = theme.trace.light if (pos.row + pos.col) % 2 == 0 else theme.trace.light
