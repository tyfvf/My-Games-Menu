...
from games_src.chess.sound import Sound
from games_src.chess.theme import Theme
...
class Config:
    ...
    def __init__(self):
        ...
        self.move_sound = Sound('./resources/audio/chess/move.wav')
        self.capture_sound = Sound('./resources/audio/chess/capture.wav')
