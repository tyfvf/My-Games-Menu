...
from games.chess.sound import Sound
from games.chess.theme import Theme
...
class Config:
    ...
    def __init__(self):
        ...
        self.move_sound = Sound('./games/audio/chess/move.wav')
        self.capture_sound = Sound('./games/audio/chess/capture.wav')
