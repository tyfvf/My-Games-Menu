...
class Game():
    ...
    def run(self):
        ...
        while True:
            ...
            if self.board.getWon():
                sound = pygame.mixer.Sound('./games/audio/win.wav')
                sound.play()
                sleep(3)
                pygame.quit()
    ...
    def loadImages(self):
        self.images = {}
        for fileName in os.listdir('./games/graphics/minesweeper'):
            if not fileName.endswith('.png'):
                continue
            image = pygame.image.load(r'./games/graphics/minesweeper/' + fileName)
