...
def main():
    ...
    player1Tex = pygame.image.load('./games/graphics/player1.png')
    player2Tex = pygame.image.load('./games/graphics/player2.png')
    ballTex = pygame.image.load('./games/graphics/ball.png')
